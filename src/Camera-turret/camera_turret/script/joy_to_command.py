...
pub1 = rospy.Publisher('/position_controller1/command', Float64, queue_size=10) #Left wheel steering
pub2 = rospy.Publisher('/position_controller2/command', Float64, queue_size=10) #Right wheel steering
